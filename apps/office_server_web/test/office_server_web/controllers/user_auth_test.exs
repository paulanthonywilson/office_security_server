defmodule OfficeServerWeb.UserAuthTest do
  use OfficeServerWeb.ConnCase, async: true

  alias OfficeServer.Accounts
  alias OfficeServerWeb.UserAuth
  import OfficeServer.AccountsFixtures

  @remember_me_cookie "_office_server_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, OfficeServerWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      OfficeServerWeb.Endpoint.subscribe(live_socket_id)
